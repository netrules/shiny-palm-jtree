 ...
 implements HelloApp.HelloOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("slay", new java.lang.Integer (0));
    _methods.put ("respawn", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // HelloApp/Hello/slay
       {
         String someText = in.read_string ();
         this.slay (someText);
         out = $rh.createReply();
         break;
       }

       case 1:  // HelloApp/Hello/respawn
       {
         String $result = null;
         $result = this.respawn ();
         out = $rh.createReply();
